...
import com.yydcdut.rxmarkdown.grammar.android.TodoGrammar;
import com.yydcdut.rxmarkdown.grammar.edit.NormalGrammar;

/**
 * Created by yuyidong on 2017/5/21.
 */
public class TodoFactory extends SyntaxFactory {

    public TodoFactory(@NonNull RxMDConfiguration rxMDConfiguration) {
        super(rxMDConfiguration);
    }

    @Override
    public IGrammar createTextSyntax() {
        return new TodoGrammar(mConfiguration);
    }
